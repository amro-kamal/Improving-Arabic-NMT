...
| mixing with (1,1.2) mixing ratio (seed=42) |  6 layers, 70 epochs / 10 epochs finetuning.      |    ?????      |   ???????    |
...
| mixing with (1,1.2) mixing ratio (seed=22)   |  6 layers, 70 epochs / 10 epochs finetuning. [notebook](https://bit.ly/3zJi8nA)|    31.68/??    |   32.18/??    |
